// Description :  MACRO that prints a plot for the Noise measurements

// Usage : root MACRO_NoisePlot.cpp
...
TString output_name      = "noise_amplitude_ntuple_3";

void MACRO_NoisePlot(){
  // PAD CUSTOM
